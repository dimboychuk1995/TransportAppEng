 ...
 *         &lt;element name="CBillNumber" type="{urn:sap-com:document:sap:rfc:functions}char10"/>
...
@XmlRootElement(name = "ZsdBillCancelResponse")
public class ZsdBillCancelResponse {

    @XmlElement(name = "BillNumber", required = true)
    protected String billNumber;
    @XmlElement(name = "CBillNumber", required = true)
    protected String cBillNumber;
    ...
    /**
     * Gets the value of the cBillNumber property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getCBillNumber() {
        return cBillNumber;
    }

    /**
     * Sets the value of the cBillNumber property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setCBillNumber(String value) {
        this.cBillNumber = value;
    }
